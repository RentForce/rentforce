...
const SMSAPI_KEY =  'App daa6aec38feddaf03cb3b0f318706f0d-5770c954-04d6-46cd-a3f7-9fd4abdd4e29'; // Replace with your API key from SMSAPI
...
const sendCode = async (req, res) => {
    ...
    try {
        if (method === 'sms') {
            ...
            recoveryCodes[phoneNumber] = code;

            // Send SMS using SMSAPI
                try {
                    const response = await axios.post('https://9kzxvd.api.infobip.com/sms/2/text/advanced', 
                        {
                            messages: [
                                {
                                    destinations: [
