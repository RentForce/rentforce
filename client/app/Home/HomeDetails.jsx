...
const HomeDetails = ({ route, navigation }) => {
  ...
  const handleChatWithReceiver = async (receiverId, receiverDetails) => {
    try {
      ...
      const otherUser = {
        id: receiverId,
        firstName: receiverDetails?.firstName || post.user?.firstName || "Property Owner",
        lastName: receiverDetails?.lastName || post.user?.lastName || "",
        image: receiverDetails?.image || post.user?.image || "https://a0.muscache.com/im/pictures/3d3800fc-7353-47da-a3ee-d5af18540589.jpg?im_w=720&im_format=avif",
      };
          ...
          <View style={styles.section}>
            ...
            >
              ...
              <View style={styles.ownerInfo}>
                <Image 
                  source={{
                    uri: post.user?.image || "https://via.placeholder.com/50"
                  }}
